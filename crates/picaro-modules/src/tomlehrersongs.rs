...
static CFG: WpBlogConfig = WpBlogConfig {
    service_name: "TomLehrerSongs",
    host: "tomlehrersongs.com",
    referer: "https://tomlehrersongs.com/",
    no_image_marker: "no-image",
    // UNVERIFIED: search anchors verified as <h2 class="entry-title">.
    url_constants: &[("songs", false), ("albums", true)],
    test_url: "https://tomlehrersongs.com/?s=poisoning+pigeons",
};
