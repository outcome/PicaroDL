...
static CFG: BlogspotConfig = BlogspotConfig {
    service_name: "ParadiseOfGarageComps",
    host: "paradiseofgaragecomps.blogspot.com",
    referer: "https://paradiseofgaragecomps.blogspot.com/",
    // UNVERIFIED: Blogspot post URLs are date based, so this is a best-effort hint only.
    url_constants: &[("20", true)],
    test_url: "https://paradiseofgaragecomps.blogspot.com/",
};
