...
static CFG: BlogspotConfig = BlogspotConfig {
    service_name: "ForwardWithTheSong",
    host: "forwardwiththesong.blogspot.com",
    referer: "https://forwardwiththesong.blogspot.com/",
    // UNVERIFIED: Blogspot post URLs are date based, so this is a best-effort hint only.
    url_constants: &[("20", true)],
    test_url: "https://forwardwiththesong.blogspot.com/",
};
