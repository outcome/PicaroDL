...
static CFG: BlogspotConfig = BlogspotConfig {
    service_name: "NuclearHolocaust",
    host: "nuclear-holocaust.blogspot.com",
    referer: "https://nuclear-holocaust.blogspot.com/",
    // UNVERIFIED: Blogspot post URLs are date based, so this is a best-effort hint only.
    url_constants: &[("20", true)],
    test_url: "https://nuclear-holocaust.blogspot.com/",
};
