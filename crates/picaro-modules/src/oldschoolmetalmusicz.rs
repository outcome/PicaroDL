...
static CFG: BlogspotConfig = BlogspotConfig {
    service_name: "OldSchoolMetalMusicz",
    host: "oldschoolmetalmusicz.blogspot.com",
    referer: "https://oldschoolmetalmusicz.blogspot.com/",
    // UNVERIFIED: Blogspot post URLs are date based, so this is a best-effort hint only.
    url_constants: &[("20", true)],
    test_url: "https://oldschoolmetalmusicz.blogspot.com/",
};
