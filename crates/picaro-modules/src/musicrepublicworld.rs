...
static CFG: BlogspotConfig = BlogspotConfig {
    service_name: "MusicRepublicWorld",
    host: "music-republic-world-traditional.blogspot.com",
    referer: "https://music-republic-world-traditional.blogspot.com/",
    // UNVERIFIED: Blogspot post URLs are date based, so this is a best-effort hint only.
    url_constants: &[("20", true)],
    test_url: "https://music-republic-world-traditional.blogspot.com/",
};
