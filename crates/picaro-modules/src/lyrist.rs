//! Lyrist module - keyless lyrics API (https://lyrist.vercel.app).
//! Best-effort: the public endpoint rate-limits (HTTP 429) under load, in which
//! case it simply returns no lyrics and the next provider is tried.
...
use crate::lyrics_ovh::artist_title;
use crate::registry::register;

const SERVICE: &str = "Lyrist";
...
pub fn module_information() -> ModuleInformation {
    ModuleInformation {
        ...
        netlocation_constant: NetlocConstants::Single("lyrist.vercel.app".to_string()),
