...
static CFG: BlogspotConfig = BlogspotConfig {
    service_name: "Butterboy",
    host: "butterboycompilations.blogspot.com",
    referer: "https://butterboycompilations.blogspot.com/",
    // UNVERIFIED: Blogspot post URLs are date based, so this is a best-effort hint only.
    url_constants: &[("20", true)],
    test_url: "https://butterboycompilations.blogspot.com/",
};
