...
static CFG: WpBlogConfig = WpBlogConfig {
    service_name: "SystemsOfRomance",
    host: "systemsofromance.com",
    // WordPress lives under the /blog/ path and the canonical host is www.
    referer: "https://www.systemsofromance.com/blog/",
    no_image_marker: "no-image",
    // UNVERIFIED: search anchors verified as <a rel="bookmark">.
    url_constants: &[("album", true), ("single", true), ("flac", true)],
    test_url: "https://www.systemsofromance.com/blog/?s=rock",
};
