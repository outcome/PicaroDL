...
static CFG: BlogspotConfig = BlogspotConfig {
    service_name: "PrimitiveOfferings",
    host: "primitiveofferings.blogspot.com",
    referer: "https://primitiveofferings.blogspot.com/",
    // UNVERIFIED: Blogspot post URLs are date based, so this is a best-effort hint only.
    url_constants: &[("20", true)],
    test_url: "https://primitiveofferings.blogspot.com/",
};
