...
static CFG: BlogspotConfig = BlogspotConfig {
    service_name: "Madrotter",
    host: "madrotter-treasure-hunt.blogspot.com",
    referer: "https://madrotter-treasure-hunt.blogspot.com/",
    // UNVERIFIED: Blogspot post URLs are date based, so this is a best-effort hint only.
    url_constants: &[("20", true)],
    test_url: "https://madrotter-treasure-hunt.blogspot.com/",
};
