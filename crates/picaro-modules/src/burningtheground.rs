...
static CFG: WpBlogConfig = WpBlogConfig {
    service_name: "BurningTheGround",
    host: "burningtheground.net",
    referer: "https://burningtheground.net/",
    no_image_marker: "no-image",
    // UNVERIFIED: search anchors verified as <h2 class="entry-title">.
    url_constants: &[("album", true), ("remix", false), ("flac", true)],
    test_url: "https://burningtheground.net/?s=remix",
};
