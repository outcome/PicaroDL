...
static CFG: BlogspotConfig = BlogspotConfig {
    service_name: "AboutDiscoWithLove",
    host: "aboutdiscowithlove.blogspot.com",
    referer: "https://aboutdiscowithlove.blogspot.com/",
    // UNVERIFIED: Blogspot post URLs are date based, so this is a best-effort hint only.
    url_constants: &[("20", true)],
    test_url: "https://aboutdiscowithlove.blogspot.com/",
};
